...
if __name__ == '__main__':
	path = 'C:\\Users\\Rushi\\Desktop\\INT-NOTES-DATA\\tsk\\LabelledData.csv' 			## path to the training data
	input = 'C:\\Users\\Rushi\\Desktop\\INT-NOTES-DATA\\tsk\\input.csv'		#train_1000.label
	result_path = 'C:\\Users\\Rushi\\Desktop\\INT-NOTES-DATA\\tsk\\Output.csv'			## path to output file
	lib_path = 'C:\\Users\\Rushi\\Desktop\\INT-NOTES-DATA\\tsk\\model\\'				## path to the trained model
	###
