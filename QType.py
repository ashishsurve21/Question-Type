# -*- coding: utf-8 -*-
"""
Created on Thu Dec  8 14:42:30 2016
...
import joblib
import pandas as pd
from FeaturesSetClass import CreateFeatures
...
if __name__ == '__main__':
	...
	"""
	path = 'C:\\Users\\Ashish\\Desktop\\INT-NOTES-DATA\\tsk\\LabelledData.csv' 			## path to the training data
	input = 'C:\\Users\\Ashish\\Desktop\\INT-NOTES-DATA\\tsk\\input.csv'		#train_1000.label
	result_path = 'C:\\Users\\Ashish\\Desktop\\INT-NOTES-DATA\\tsk\\Output.csv'			## path to output file
	lib_path = 'C:\\Users\\Ashish\\Desktop\\INT-NOTES-DATA\\tsk\\model\\'				## path to the trained model
